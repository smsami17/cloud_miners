                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <form action="bank_submit.php" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" required name="account_number" onkeypress="return isNumber(event)" type="text">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" required name="branch_name" type="text">

                                                </div>
                                                <div class="col-md-4 ">

                                                    <label class="col-form-label">USDT <span class="text-sm" style="color:white">
                                                    (Optional)
                                                    <!-- (For receiving income in USD) -->
                                                </span></label>
                                    ...
                                    ?>
                                      <h4 class="card-title">
                                            Bank Details
                                            <!-- <a href="edit_bank_details.php" style="float: right;" class="btn btn-primary">Edit</a> -->
                                        </h4>
                                        <form method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" readonly value="<?php echo $row['bank_name'] ?>" required name="bank_name" type="text">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" readonly value="<?php echo $row['account_holder_name'] ?>" required name="account_holder_name" type="text">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" readonly value="<?php echo $row['account_number'] ?>" required name="account_number" type="text">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" readonly value="<?php echo $row['ifsc'] ?>" required name="ifsc" type="text">
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <input class="form-control" readonly value="<?php echo $row['branch_name'] ?>" required name="branch_name" type="text">

                                                </div>
                                                <div class="col-md-4 ">

                                                    <label class="col-form-label">USDT <span class="text-sm" style="color:white">(Optional)</span></label>

                                                    <input class="form-control" readonly value="<?php echo $row['usdt'] ?>" name="usdt" type="text">
