                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="text-center ">
                                        <i class="fa-solid fa-indian-rupee-sign"></i> <?php echo total_income($user_id) ?>
                                    </h3>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example" class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 0;
                                                $category = mysqli_query($conn, "select * from wallet where user_id='$user_id' ORDER BY creation_date DESC  ");
