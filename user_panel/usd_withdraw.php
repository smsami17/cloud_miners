            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="row ">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="text-center ">
                                        <i class="fa-solid fa-dollar-sign"></i> <?php

                                                                            
                                                                                $foo = fund_wallet_balance($user_id)/$usd_rate;
                                                                                $foo = number_format((float)$foo, 2, '.', '');
                                                                                echo $foo;
                                                                                ?>
                                    </h3>
                        ...
                        <?php } else if (usdt($user_id) == null) { ?>
                            <div class="col-md-4">
                                <div class="card">

                                    <div class="card-body">
                                        <p class="text-center">Add USDT to withdraw money in USD</p>
                                        <h3 class="text-center ">
                                            <a href="edit_bank_details.php" class="btn btn-danger">Add USDT</a>
                                        </h3>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="text-center">Withdraw in INR</h5>
                                    <h3 class="text-center ">
                    ...
                    <?php  
                    if(bank_details($user_id) != 0) {
                    if (usdt($user_id) != null) { ?>
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="./withdraw_submit.php" method="post">
                                            <div class="form-group row">
                                                ...
                                                <?php
                                                $_SESSION['current_income'] = $foo;
                                                ?>

                                                <div class="col-md-4 ">
                                                <input type="hidden" name="type" value="USD">
                                                    <label class="col-form-label">Enter Amount <i class="fa-solid fa-dollar-sign"></i></label>
                                                ...
                                                <div class="col-md-4 ">
                                                    ...
                                                    <label class="col-form-label">Select USDT</label>
                                                    <select required  id="bank" class="form-control">
                                                        <option value="">Select USDT</option>
                                                        <option value="<?php echo usdt($user_id) ?>"><?php echo usdt($user_id) ?></option>
                                                    </select>
        ...
        $(document).ready(function() {
            $('#country').on('change', function() {
                ...
                if (countryID) {
                    $.ajax({
                        type: 'POST',
                        url: 'check_fund_usd.php',
                        data: 'country_id=' + countryID,
                        success: function(html) {

                            if (html == 1) {
                                alert("Minimum withdraw amount Should be INR500");
