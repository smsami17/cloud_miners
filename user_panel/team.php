                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $category = mysqli_query($conn, "select * from users where ref_id='$user_id' or ref2='$user_id' or ref3='$user_id' or ref4='$user_id' or ref5='$user_id'  ORDER BY creation_date DESC  ");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $fetch_category['name'] ?></td>

                                                        <td class="text-center">
                                                            <?php if (activation_staus($id) == 0) { ?>
                                                                <button class="btn btn-warning py-2">Pending</button>
                                                            <?php } else { ?>
                                                                <button class="btn btn-success py-2">
                                                                    <i class="fa-solid fa-indian-rupee-sign"></i> <?php echo $fetch_category['activation_amount'] ?>
                                                                </button>
                                                            <?php } ?>
                                                        </td>
                                                        <td class="text-center"><?php $ans = $fetch_category['level'] - $level;
                                                                                echo $ans;
                                                                                ?></td>
