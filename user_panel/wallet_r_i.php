                    ...
                    <div class="row ">
                         ...
                         <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-center">
                                        Daily Royalty Income
                                    </p>
                                    <h3 class="text-center ">
                                    <i class="fa-solid fa-indian-rupee-sign"></i> <?php
                                        echo total_royalty_income($user_id);
                                        ?>
                                    </h3>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="example" class="table">
                                            ...
                                            <tbody>
                                                <?php
$i = 0;
                                                $category = mysqli_query($conn, "select * from wallet where user_id='$user_id' and type='royalty_income' ORDER BY creation_date DESC  ");
