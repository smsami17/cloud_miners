                ...
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">View Fund Request</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $i = 0;
                                                $category = mysqli_query($conn, "select * from fund_request where status!=2  order by fund_id DESC ");
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center"> <?php echo $i ?> </td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <?php } else if($fetch_category['status'] == 1) { ?>
