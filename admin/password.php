...
if (isset($_POST['password'])) {
    ...
    $sql_update = mysqli_query($conn, "UPDATE admin set password='$_POST[password]'");
...
function user($id)
{
    ...
    $sqls = mysqli_query($conn, "select * from users where  user_id='$id'");
...
function provider($id)
{
    ...
    $sqls = mysqli_query($conn, "select * from service_provider where   provider_id='$id'");

    $datas = mysqli_fetch_array($sqls);

    return $datas['shop_name'];
...
function product($id)
{
    ...
    $sqls = mysqli_query($conn, "select * from product where  product_id='$id'");
...
function delivery_boy($id)
{

    include('../includes/connection.php');

    $sqls = mysqli_query($conn, "select * from partner_user where  partner_id='$id'");
...
<body>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="memberModalLabel"
        aria-hidden="true">
                            ...
                            <form action="" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input maxlength="6" minlength="6" class="form-control" required name="password"
                                            type="password">
