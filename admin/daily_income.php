                ...
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">View Daily Income</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $i = 0;
                                                $category = mysqli_query($conn, "select * from daily_mining_bonus  order by id DESC ");
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center"><?php echo $i; ?></td>
                                                        ...
                                                        <td class="text-center"> <?php echo $fetch_category['day'] ?> </td>
