                ...
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">View Activation Request</h4>
                                        ...
                                        <table class="table" id="example">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">Name of Payer</th>
                                                    <th class="text-center">User Id of Payer</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $i = 0;
                                                $category = mysqli_query($conn, "select * from activation_request  order by id DESC ");
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center"> <?php echo $i ?> </td>
                                                        ...
                                                        <td class="text-center"> <?php
                                                                                    if ($fetch_category['buyer_id'] == "Admin") {
                                                                                        echo $fetch_category['buyer_id'];
                                                                                    } else {
                                                                                        echo user_name($fetch_category['buyer_id']);
                                                                                    } ?> </td>

                                                        <td class="text-center"> <?php echo $fetch_category['buyer_id'] ?> </td>
