    ...
    <div class="container register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <p>Reset your password and start earning now</p>
                <a href="index.php">
                    <img src="assets/img/logo_final.png" style="width: 150px;margin-top:-25px" alt="" class="mb-4">
                </a>
                        ...
                        <form action="api/reset_password.php" method="post">
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input onkeyup="check()" minlength="6" type="password" id="confirm_password" required class="form-control" placeholder="Confirm Password *" value="" />
